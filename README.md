...
## Self evaluation:
In terms of effectiveness I’d say I was rather effective given the hurdles faced while writing the program. Although I could’ve been a lot more effective as there was a lot of time used in trouble shooting and find ways to solve issues I was facing. For the most part I’d say it went well because the program works and does what it’s supposed to do even. For what I ended up with I feel like I did a good job stress testing as I ended with something that I couldn’t find a way to break. That being said if I were to redo it again with what I know now a lot would change.  One of the biggest things that could have gone better was the original planing and scope of the program. As while going through the project I had to take lots of short cuts and completely cut out features I had planned due to time concerns. This caused many issues one of these is that older code like the recipe class has a function addIngrediant that wasn’t fully used. I had originally planned for the program to auto read and add recipes from a .csv file but decided against this as it meant I needed to take time learning how to do this. I did think it was doable in fact I tried looking how too but because of life, time just wasn’t there for it. I end up hard coding the recipes and ingredients. Another thing I could’ve done better was names and or consistency with names, one of these is the struct vector for ingredients in the recipe class, its string that stores its name is just name which works but would’ve been better to name it something reflecting whats name it is. The bigger of these issues is the use of 5 or 6 in the code instead of using a int variable standing in for it. As a whole Im glad it worked out and existed to work on it more once school ends, hopefully on an actual computer this time.